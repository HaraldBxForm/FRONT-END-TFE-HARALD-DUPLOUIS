      ...
      <div className="relative z-10 w-full flex flex-col items-center justify-center min-h-screen px-4">
        ...
        >
          ...
          <p className="text-lg md:text-lg text-white/80 mb-6">
            Sorry, the article you are looking for does not exist or may have been removed. 
            You can return to the news page to explore other articles and updates from OceanSavers.
          </p>
          <Link
            href="/news"
